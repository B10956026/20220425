...
namespace _20220425
{
    public partial class Form1 : Form
    {
        ...
        // 登入伺服器
        private void btn_Login_Server_Click(object sender, EventArgs e)
        {
            ...
            T = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp); // 建立可以雙向通訊的TCP連線
